    ...
    <div id="what-is-WebDollar">
        ...
        <div id="aboutSection" class="fullSection backgroundSection">
            <div class="verticalAlignMiddle sectionCenteredWidth">
                ...
                <span class="pageTitle alignCenter titleMarginBottom removeBackground aboutTitle">What is Imperium?</span>
                <div id="whatContainer">
                    <div>
                        ...
                        <p>You can start mining IDLL immediately with the first blockchain running directly in your Browser, on any device</p>
                    </div>
                    <div>
